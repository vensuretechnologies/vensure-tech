    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="reveal flex items-center gap-3 mb-4">
          ...
          <span className="font-mono text-xs tracking-[0.25em] text-purple-bright/70 uppercase">How We Work</span>
        </div>
        ...
        <div className="absolute top-1/2 -right-4 -translate-y-1/2 hidden lg:flex flex-col items-center gap-3 opacity-20">
          <div className="w-px h-32 bg-gradient-to-b from-purple-glow to-transparent" />
          <span className="font-mono text-[9px] tracking-[0.3em] text-purple-bright [writing-mode:vertical-rl]">
            PROCESS
          </span>
        </div>
      </div>

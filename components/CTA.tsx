...
export default function CTA() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-grid-brand bg-grid opacity-50" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-brand-red/10 blur-[160px] rounded-full pointer-events-none" />
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <span
          ...
          style={{
            ...
            WebkitTextStroke: '1px rgba(220,38,38,0.06)',
            color: 'transparent',
            lineHeight: 1,
          }}
        >
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        <div className="reveal flex items-center gap-3 mb-6 justify-center">
          ...
          <span className="font-mono text-xs tracking-[0.25em] text-brand-red-bright/70 uppercase">Ready to Start?</span>
          <div className="w-6 h-px bg-brand-red-glow" />
        </div>
        ...
        <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-5">
          <button
            ...
            className="group inline-flex items-center gap-3 px-10 py-5 font-body text-sm font-semibold tracking-[0.15em] uppercase bg-brand-red-glow text-white hover:bg-brand-red-bright transition-all duration-300 animate-glow-pulse"
          >
            Start a Project
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-5 font-body text-sm font-semibold tracking-widest uppercase border border-brand-red-glow/30 text-white/50 hover:text-brand-red-bright hover:border-brand-red-glow/60 transition-all duration-300"
          >
            Schedule a Call
          </a>
        </div>
        ...
        {/* Contact info strip */}
        <div className="reveal mt-20 pt-10 border-t border-brand-red-glow/10 flex flex-col sm:flex-row items-center justify-center gap-10">
          {[
            ...
            <div key={label} className="text-center">
              <div className="font-mono text-[10px] tracking-[0.25em] uppercase text-brand-red-glow/40 mb-1">{label}</div>
